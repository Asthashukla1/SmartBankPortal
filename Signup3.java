...
class Signup3 extends JFrame implements ActionListener {
    ...
    Signup3(String formno) {
        ...
        l4.setFont(new Font("Cambria", Font.BOLD, 18));

        l5 = new JLabel("(Your 16-digit Card number)");
        l5.setFont(new Font("Cambria", Font.BOLD, 12));

        l6 = new JLabel("It would appear on ATM Card/Cheque Book and Statements");
        l6.setFont(new Font("Cambria", Font.BOLD, 12));

        l7 = new JLabel("PIN:");
        l7.setFont(new Font("Cambria", Font.BOLD, 18));

        l8 = new JLabel("XXXX");
        l8.setFont(new Font("Cambria", Font.BOLD, 18));

        l9 = new JLabel("(4-digit password)");
        l9.setFont(new Font("Cambria", Font.BOLD, 12));

        l10 = new JLabel("Services Required:");
        l10.setFont(new Font("Cambria", Font.BOLD, 18));

        l11 = new JLabel("Form No:");
        l11.setFont(new Font("Cambria", Font.BOLD, 14));

        l12 = new JLabel(formno);
        l12.setFont(new Font("Cambria", Font.BOLD, 14));
        ...
        r1.setFont(new Font("Cambria", Font.BOLD, 16));
        r1.setBackground(Color.WHITE);

        r2 = new JRadioButton("Fixed Deposit Account");
        r2.setFont(new Font("Cambria", Font.BOLD, 16));
        r2.setBackground(Color.WHITE);

        r3 = new JRadioButton("Current Account");
        r3.setFont(new Font("Cambria", Font.BOLD, 16));
        r3.setBackground(Color.WHITE);

        r4 = new JRadioButton("Recurring Deposit Account");
        r4.setFont(new Font("Cambria", Font.BOLD, 16));
        ...
        c3.setBounds(100, 495, 200, 30);
        add(c3);

        c4.setBounds(350, 495, 200, 30);
        add(c4);
        ...
        try {
            if (ae.getSource() == b1) {
                ...
                if (atype.equals("")) {
                    ...
                    String q1 = "insert into siup8 values('" + atype + "','" + cardno + "','" + pin + "','" + facility
                            + "')";
                    String q2 = "insert into login1 values('" + cardno + "','" + pin + "')";
                    st.executeUpdate(q1);
                    st.executeUpdate(q2);
