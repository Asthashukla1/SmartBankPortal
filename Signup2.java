...
class Signup2 extends JFrame implements ActionListener {
    ...
    Signup2(String formno) {
        ...
        l5.setFont(new Font("Cambria", Font.BOLD, 18));

        l11 = new JLabel("Qualification:");
        l11.setFont(new Font("Cambria", Font.BOLD, 18));

        l6 = new JLabel("Occupation:");
        l6.setFont(new Font("Cambria", Font.BOLD, 18));
        ...
        l9.setFont(new Font("Cambria", Font.BOLD, 18));

        l10 = new JLabel("Existing Account:");
        l10.setFont(new Font("Cambria", Font.BOLD, 18));

        l12 = new JLabel("Form No:");
        l12.setFont(new Font("Cambria", Font.BOLD, 13));

        l13 = new JLabel(formno);
        l13.setFont(new Font("Cambria", Font.BOLD, 13));

        b = new JButton("Next");
        b.setFont(new Font("Cambria", Font.BOLD, 14));
        ...
        t2 = new JTextField();
        t2.setFont(new Font("Cambria", Font.BOLD, 14));
        ...
        r3.setFont(new Font("Cambria", Font.BOLD, 14));
        r3.setBackground(Color.WHITE);

        r4 = new JRadioButton("No");
        r4.setFont(new Font("Cambria", Font.BOLD, 14));
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        try {
            if (t2.getText().equals("")) {
                ...
                String q1 = "insert into siup2 values('" + religion + "','" + category + "','" + income + "','"
