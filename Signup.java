...
public class Signup extends JFrame implements ActionListener {
    ...
    Signup() {
        ...
        l13 = new JLabel("Date");
        l13.setFont(new Font("Cambria", Font.BOLD, 14));

        l14 = new JLabel("Month");
        l14.setFont(new Font("Cambria", Font.BOLD, 14));

        l15 = new JLabel("Year");
        l15.setFont(new Font("Cambria", Font.BOLD, 14));
        ...
        r5.setFont(new Font("Cambria", Font.BOLD, 14));
    ...
    public void actionPerformed(ActionEvent ae) {
        String form = first;
        String n_ame = t1.getText();
        String first = t2.getText();
        String d_o_b = t3.getText();
        String gender = null;
        if (r1.isSelected()) {
            gender = "Male";
        ...
        try {
            ...
            if (t6.getText().equals("")) {
                ...
                String q1 = "insert into siup4 values('" + form + "','" + n_ame + "','" + first + "','" + d_o_b + "','"
                        + gender + "','" + email + "','" + marital + "','" + address + "','" + city + "','" + code
                        + "','" + state + "')";
                st.executeUpdate(q1);
